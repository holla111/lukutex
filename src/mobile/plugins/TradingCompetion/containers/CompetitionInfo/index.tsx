            ...
            <React.Fragment>
                <div className="row">
                    <div className="col-12 text-center">
                        <h2 className="competition-info-mobile__title" style={{ color: '#f07c22' }}>Become a winner and get a prize</h2>
                    </div>
                </div>
                <div className="row">
                    <div className="col-12 text-center">
                ...
                <React.Fragment>
                    ...
                    <div className="row">
                        <div className="col-12 text-center mt-3">
                            ...
                            <Button type="primary" className="mt-2" disabled={marketIDState === ''} onClick={handleGoTrading}>Let's Trade</Button>
                        </div>
                    </div>
                </React.Fragment>
            );
