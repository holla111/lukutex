...
export const en = {
    ...
    'page.body.wallets.tabs.deposit.ccy.message.confirmation': '1. Coins will be deposited after {confirmations} network confirmations.',
    ...
    'page.body.history.withdraw.content.status.skipped': 'Waiting Admin',
    'page.body.history.withdraw.content.status.canceled': 'Failed',
    'page.body.history.withdraw.content.status.accepted': 'Waiting Admin',
    'page.body.history.withdraw.content.status.suspected': 'Suspected',
    'page.body.history.withdraw.content.status.rejected': 'Rejected by Admin',
