    ...
    return (
        <div className="row justify-content-center">
            <div className="col-12">
                <h2 style={{ fontWeight: 'bold', fontSize: '2rem' }}>1. Lukutex Token Information</h2><br/>
                ...
                <br/>
                <h2 style={{ fontWeight: 'bold', fontSize: '2rem' }}>2. IEO Bonus Detail</h2><br/>
                <p style={{ fontSize: '1.6rem' }}>
                    <strong style={{ color: '#fff' }}>Buy 2.000-4.000 LKT: </strong>Got 5% Bonus
                    <br/><br/>
                    <strong style={{ color: '#fff' }}>Buy 4.001-20.000 LKT: </strong>Got 10% Bonus
                    <br/><br/>
