        ...
        <div className="container" style={{ padding: '20px 0' }}>
            <div className="row">
                <div className="col-8 d-flex flex-row">
                    <DepositButtonStyles>Deposit</DepositButtonStyles>
                    <WithdrawButtonStyles
                        onClick={() => history.push({ pathname: `/new-wallets/withdraw/${currency_id.toUpperCase()}` })}>
                        Withdraw
                    </WithdrawButtonStyles>
                </div>
                <div className="col-4">
            ...
            <div className="row mt-5" style={{ fontSize: '1.3rem' }}>
                <div className="col-6">
                    <div className="d-flex align-items-center">
                        ...
                        <span className="ml-2">{intl.formatMessage({ id: 'page.body.plugins.wallet.deposit.info.notice' })}: </span>
                    </div>
                    <div className="ml-2 mt-2">

                        <p>{intl.formatMessage({ id: 'page.body.plugins.wallet.deposit.info.notice1' })}</p>
                        <p>{intl.formatMessage({ id: 'page.body.plugins.wallet.deposit.info.notice2' })}</p>
                    </div>
                </div>
                <div className="col-6">
                    <div className="d-flex align-items-center">
