...
const guideContent =
    <p>     <strong style={{ textDecoration: 'underline' }}>Task Step</strong> <br /><br />
            1. Have an account/register on <a href="https://www.lukutex.com/signup"
            style={{ color: '#1155cc !important' }} target="_blank" rel="noopener noreferrer">LuKuTex</a><br />
            2. Come <a href="https://www.lukutex.com/airdrop"
            style={{ color: '#1155cc !important' }} target="_blank" rel="noopener noreferrer">Lukutex Airdrop Hub</a> and Join Safari Token Airdrop<br />
        ...
        <strong style={{ textDecoration: 'underline' }}>Condition:</strong> <br /><br />
            1. Have Lukutex account before 1st January 2021. <br />
            2. Have min deposit 0.05ETH and Trade 1 time in Lukutex Exchange<br />
