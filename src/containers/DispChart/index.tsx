...
export const DispChart: React.FC<any> = () => {
                ...
                <div className="container" onClick={() => history.push(`/trading/${baseCurrency.toLowerCase() + quoteCurrency.toLowerCase()}`)}>
                    <div className="row">
                        <div className="col-12 d-flex justify-content-between">
                            ...
                            <span style={{ color: '#fff', padding: '0.5rem 1rem', backgroundColor: '#1e2841', borderRadius: '1rem', fontWeight: 'bold' }}>24H</span>
                        </div>
                    </div>
                    <div className="row mt-2">
                        <div className="col-6 d-flex justify-content-start align-items-center">
                            <span style={{ marginLeft: '5px', fontSize: '1.6rem', color: '#fff' }}>{last.toFixed(6)}</span>
                        </div>
                    ...
                    <div className="row mt-2">
                        <div className="col-12" >
                            <ResponsiveContainer ani width='100%' aspect={4.0 / 1.0}>
                                <AreaChart
                                    width={200}
                                    height={60}
                                    data={data}
                                ...
                                >
                                    <Area isAnimationActive={false} type="monotone" dataKey="pv" stroke="#fff" fill="#8884d8" />
                                </AreaChart>  
                            </ResponsiveContainer>
                        </div>
                    </div>
  ...
  const renderChart = () => {
    return (
        <ChartWrap>
            <div className="container" style={{ backgroundColor: 'transparent', padding: '15px 15px', borderRadius: '1rem' }}>
                <div className="row">
